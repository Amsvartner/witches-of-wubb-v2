...
- **Category icon set (new reference concept-3, 2026-07-15):** the approved reference image draws **Melody as a sine-wave** and **Bass as a hexagram**, not the **treble clef / bass clef** in `DESIGN_PROPOSAL_001.md` §3.3 (and the hexagram is an "arbitrary occult symbol" the rejection list bars). Decide the icon set: follow the reference's symbols (mic / sine-wave / hexagram / drum-circle) or keep conventional clefs (mic / treble-clef / bass-clef / drum-kit). Vocals + Drums are consistent either way.
