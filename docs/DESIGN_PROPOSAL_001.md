...
| Category         | LED-match fill (`-700`, medallions/accents) | Text/label tint (`-300`, legible on page) | Icon meaning (realised by the icon system — §3.11) |
| ---------------- | ------------------------------------------- | ----------------------------------------- | -------------------------------------------------- |
| **Vocals (Vox)** | `#b91c1c`                                   | `#fca5a5`                                 | Vintage / clear **microphone**                     |
| **Melody**       | `#a16207`                                   | `#fcd34d`                                 | **Treble clef**                                    |
| **Bass**         | `#15803d`                                   | `#86efac`                                 | **Bass clef**                                      |
| **Drums**        | `#1d4ed8`                                   | `#93c5fd`                                 | **Drum kit / snare** (clear percussion)            |
